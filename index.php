...
<body class="loading">
    ...
    <div class="top-info-bar" id="topInfoBar">
        <div class="top-bar-container">
            <div class="top-bar-left">
                <a href="tel:+914423456789" class="top-bar-item">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path
                            d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
            ...
            <div class="about-grid">
                ...
                <div class="about-image">
                    <div class="about-image-wrapper">
                        <img id="aboutImage" src="assets/images/new-building.jpg" alt="CAAD Modern Campus Architecture">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="stacking-card">
                    <div class="card-inner">
                        ...
                        <div class="card-image">
                            <img src="assets/images/caad-campus-09.jpg" alt="B.Arch">
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="campus-grid">
                ...
                <div class="campus-images">
                    <img src="assets/images/caad-campus-14.jpg" alt="CAAD Campus Main Building" class="campus-main-img">
    ...
    <script>
        ...
        function initParallax() {
            const parallaxElements = document.querySelectorAll('.about-image-wrapper img, .campus-image-main img');
