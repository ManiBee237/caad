...
<head>
    ...
    <meta name="description"
        content="Sitemap - Complete navigation map of CAAD Chennai Academy of Architecture and Design website. Find every page across all sections.">
    <title>Sitemap | CAAD Chennai</title>
...
<body>
    ...
    <section class="page-header">
        <div class="container">
            ...
            <p class="page-subtitle">Complete navigation map of the old caad.ac.in website</p>
        </div>
    </section>
    ...
    <section class="sitemap-section">
        <div class="container">
            <div class="sitemap-overview">
                <p>A comprehensive directory of every page and section from the original CAAD website at caad.ac.in, organized by category.</p>
            </div>
            ...
            <div class="sitemap-grid">
                ...
                <div class="sitemap-card">
                    ...
                    <ul class="sitemap-links">
                        ...
                        <li><a href="https://caad.ac.in/international-collabration/" target="_blank" rel="noopener">International Collaboration (Legacy)</a></li>
